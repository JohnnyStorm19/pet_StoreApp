  ...
  return (
    <div className="flex flex-col gap-8 md:gap-24 scroll-smooth">
      ...
      <div className="px-[30px] flex justify-end md:gap-[90px] gap-5 items-center md:flex-row flex-col">
        <CtAImage image="pet_StoreApp/src/assets/images/CtA/CtA_2_small.jpg" navigateLink="/new" title="Новое поступление" />
        <CtAImage image="pet_StoreApp/src/assets/images/CtA/CtA_1_large.jpg" navigateLink="/catalogue" title="Возьми все" />
      </div>
